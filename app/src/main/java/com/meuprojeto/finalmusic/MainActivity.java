...
public class MainActivity extends AppCompatActivity {
    ...
    private ListView myListViewSongs;
    String[] itens;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myListViewSongs = findViewById(R.id.mySongListView);
    ...
    void display(){
        ...
        for(int i=0; i<mySongs.size();i++){
            ...
            itens[i] = mySongs.get(i).getName().toString().replace(".mp3","").replace(".wmv","");
        }
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,itens);
